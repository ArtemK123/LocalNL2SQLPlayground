...
LocalNL2SQLPlayground/
  ...
  experiments/          # reproduction runbooks for A/B/C
  nl2sql-comparison/    # runnable package (Compose, stacks, harness, Terraform, profiles)
```

Runnable code lives under [`nl2sql-comparison/`](nl2sql-comparison/). Start there after cloning.
...
# Follow experiments/A-*.md, B-*.md, or C-*.md
```

**Prerequisites (typical):** Docker Desktop, PowerShell 7+, Python 3.13, Playwright (for UI harness), AWS CLI + Terraform (Experiments B/C).
